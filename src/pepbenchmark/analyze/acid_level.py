"""Amino-acid level statistics and k-mer analysis utilities.

This module focuses on residue-level sequence analysis for peptide datasets.
It currently provides a reusable k-mer analysis workflow for canonical amino
acid sequences.
"""
...
class AcidLevelAnalyzer:
    """Compute amino-acid k-mer statistics for peptide sequences.
...
if __name__ == "__main__":
    ...
    analyzer_1 = AcidLevelAnalyzer(example_sequences_1, k=3)
    analyzer_2 = AcidLevelAnalyzer(example_sequences_2, k=3)
    ...
    print(stats_1)
    print(stats_2)
    print("\nTop-5 by count:", AcidLevelAnalyzer.top_kmers(stats_1, n=5, by="count"))
    print(
        "Top-5 by occurrence:",
        AcidLevelAnalyzer.top_kmers(stats_1, n=5, by="occurrence"),
    )
    print("Top-5 by freq:", AcidLevelAnalyzer.top_kmers(stats_1, n=5, by="freq"))
